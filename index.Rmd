...
subtitle: "Hands-on code to create various chart with R Programming Language"
...
To make slope graph, we use *df_for_slope*.
...
We use different color pallete for each chart type.
