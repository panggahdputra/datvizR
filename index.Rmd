...
Sebelum melangkah lebih jauh, saya asumsikan anda sudah cukup memahami bahasa pemrograman R dan sudah menginstal [R](https://cran.r-project.org/){target='blank'} dan [Rstudio](https://www.rstudio.com/products/rstudio/#Desktop){target='blank'}.
...
Grafik dalam website ini dibuat dengan menggunakan beberapa dataset. Sebagian besar grafik pada tipe grafik-deviasi, korelasi, dan peringkat dibuat dengan menggunakan [gapminder](https://github.com/jennybc/gapminder){target='blank'} dataset dengan beberapa proses manipulasi data.

Sebagian besar grafik pada tipe grafik-distribusi dibuat dengan menggunakan dataset `main_df`, terinsiprasi dari [flipbook_script.R](https://osf.io/vt2ny/){target='blank'} yang disebut oleh Cédric Scherer dalam websitenya, [Beyond Bar and Box Plots](https://z3tt.github.io/beyond-bar-and-box-plots/#import-data){target='blank'}.

Seluruh grafik dalam website ini dibuat dengan menggunakan palet warna [Navajo Palette](https://github.com/BlakeRMills/MetBrewer#navajo){target='blank'} dari [MetBrewer](https://github.com/BlakeRMills/MetBrewer){target='blank'}.

***

## **Prasyarat**

Seperti yang sudah disebutkan sebelumnya, saya asumsikan anda sudah cukup memahami bahasa pemrograman R dan sudah menginstal R dan Rstudio.
...
Sebagian besar grafik pada tipe grafik-deviasi, korelasi, dan peringkat dibuat dengan menggunakan <span style='color: green;'>**gapminder**</span> dataset dengan beberapa proses manipulasi data.
...
Dot Strip Plot pada tipe grafik-peringkat dibuat dengan menggunakan `rank_dot_strip_plot_df` di bawah ini.

```{r}

set.seed(2000)
df1 = tibble(var1 = 'Variable 1',
             var2 = c('A','B','C','D','E','A','B','C','D','E'),
             val = sample(1:20, 10))
df2 = tibble(var1 = 'Variable 2',
             var2 = c('A','B','C','D','E','A','B','C','D','E'),
             val = sample(1:20, 10))
df3 = tibble(var1 = 'Variable 3',
             var2 = c('A','B','C','D','E','A','B','C','D','E'),
             val = sample(1:20, 10))
df4 = tibble(var1 = 'Variable 4',
             var2 = c('A','B','C','D','E','A','B','C','D','E'),
             val = sample(1:20, 10))
df5 = tibble(var1 = 'Variable 5',
             var2 = c('A','B','C','D','E','A','B','C','D','E'),
             val = sample(1:20, 10))

rank_dot_strip_plot_df <- rbind(df1, df2, df3, df4, df5)
...
Seluruh grafik dalam website ini dibuat dengan menggunakan palet warna `our_palette` dari <span style='color: green;'>**Navajo Palette**</span> di <span style='color: green;'>**MetBrewer**</span>. Kode hex disalin secara manual untuk mempersempit fokus latihan. Jika tidak ingin menyalin code hex secara manual, penggunaan palet warna pada <span style='color: green;'>**MetBrewer**</span> dapat dipelajari sendiri [di sini](https://github.com/BlakeRMills/MetBrewer/tree/main#functions){target='blank'} .
...
Seluruh grafik dalam website ini menggunakan tema `our_theme` di bawah ini.
...
bump <- bump_df %>%
  ...
  geom_text(aes(label = ranking),
            ...
            fontface = 'bold',
            color = 'white') +
  geom_text(data = bump_df %>% filter(year == 1967),
            aes(x = year - 1.1,
                label = continent),
            size = 4,
            fontface = 'bold',
            hjust = 1) +
  geom_text(data = bump_df %>% filter(year == 2007),
            aes(x = year + 1.1,
                label = continent),
            size = 4,
            fontface = 'bold',
  ...
  ylab('ranking by max life expectancy') +
