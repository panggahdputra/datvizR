...
Dot strip plot pada tipe grafik-peringkat dibuat dengan menggunakan dataset *df_for_rank_dotstrip*.
...
Bump chart dibuat dengan menggunakan dataset *df_for_bump*.
...
Slope graph dibuat dengan menggunakan dataset *df_for_slope*.
...
Population pyramid dibuat dengan menggunakan dataset *df_for_pop_pyramid*.
...
Cumulative curve dibuat dengan menggunakan dataset *df_for_cum_curve*.
...
Tiap tipe grafik dibuat dengan menggunakan palet warna berbeda. Untuk mempercantik tipe grafik-peringkat, palet yang digunakan adalah palet *palette_ranking*. Untuk mempersempit fokus latihan, kode hex disalin secara manual dari *Greek Palette* di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#greek){target="blank"}. Anda dapat mempelajari sendiri penggunaan palet warna pada [MetBrewer](https://github.com/BlakeRMills/MetBrewer#greek){target="blank"} tanpa harus menyalin code hex secara manual.
...
Untuk mempercantik tipe grafik-distribusi, palet yang digunakan adalah palet *palette_distr*. Kode hex disalin secara manual dari *Isfahan1 Palette* di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#isfahan1){target="blank"}.
...
Tiap tipe grafik dibuat dengan menggunakan tema berbeda. Untuk mempercantik tipe grafik-peringkat, tema yang digunakan adalah tema *theme_ranking*.
...
Untuk mempercantik tipe grafik-distribusi, tema yang digunakan adalah tema *theme_distr*.
