...
The classification of the charts in this website is based on the [Financial Times visual vocabulary](https://github.com/Financial-Times/chart-doctor/tree/main/visual-vocabulary)
with addition of other resources.

***

##### Color Palettes

Color palettes we are use above is come from [MetBrewer](https://github.com/BlakeRMills/MetBrewer). 

***

##### Datasets

Inspiration of the *main_df* above is come from [flipbook_script.R](https://osf.io/vt2ny/).
