...
Untuk mempercentantik tipe grafik-peringkat, palet yang digunakan adalah palet `palette_ranking`. Kode hex disalin secara manual dari <span style='color: green;'>**Greek Palette**</span> di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#greek){target='blank'}. 
...
Untuk mempercentantik tipe grafik-distribusi, palet yang digunakan adalah palet `palette_distr`. Kode hex disalin secara manual dari <span style='color: green;'>**Isfahan1 Palette**</span> di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#isfahan1){target='blank'}.
...
Tiap tipe grafik dibuat dengan menggunakan tema berbeda. Untuk mempercentantik tipe grafik-deviasi, tema yang digunakan adalah tema `theme_dev` di bawah ini.
...
Untuk mempercentantik tipe grafik-korelasi, tema yang digunakan adalah tema `theme_corr` di bawah ini.
...
Untuk mempercentantik tipe grafik-peringkat, tema yang digunakan adalah tema `theme_ranking` di bawah ini.
...
Untuk mempercentantik tipe grafik-distribusi, tema yang digunakan adalah tema `theme_distr` di bawah ini.
...
diverging_stacked_bar <- diver_stack_bar_df %>%
  ggplot(aes(x = percent_country,
             ...
             fill = cluster)) + 
  geom_col(width = .6,
           fill = if_else(diver_stack_bar_df$percent_country > 0,
                          '#2b5851',
                          '#ce9344')) +
  geom_textvline(xintercept = 0,
                 label = 'Median Life Expectancy',
  ...
  geom_text(aes(label = scales::percent(abs(percent_country), 2),
            ...
            color = 'white') +
  theme_dev +
  xlab('Number of Country (in percentent)') +
...
col_line_tl <- gapminder %>%
  ...
  geom_textline(aes(x = year,
                    y = lifeExp*20),
                label = 'Life Expectancy', size = 3, vjust = -0.5,
