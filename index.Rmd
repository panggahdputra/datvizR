...
Seluruh grafik dalam website ini menggunakan palet warna `our_palette` dari <span style='color: green;'>**Navajo Palette**</span> di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#navajo){target='blank'}.
...
Seluruh grafik pada tipe grafik-deviasi dan tipe grafik-korelasi menggunakan `gapminder` dataset dengan beberapa proses manipulasi data.
...
Seluruh grafik dalam website ini menggunakan palet warna `our_palette` dari <span style='color: green;'>**Navajo Palette**</span> di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#navajo){target='blank'}. Kode hex disalin secara manual untuk mempersempit fokus latihan. Jika tidak ingin menyalin code hex secara manual, penggunaan palet warna pada MetBrewer dapat dipelajari sendiri [di sini](https://github.com/BlakeRMills/MetBrewer/tree/main#functions){target='blank'} .
