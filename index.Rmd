...
Scatter Plot dan Scatter Plot with Regression Line pada tipe grafik-korelasi dibuat menggunakan `iris` Dataset. Sedangkan Column + Line Timeline, Connected Scatter Plot, Bubble, serta XY Heatmap pada tipe grafik-korelasi menggunakan `gapminder` dataset.
