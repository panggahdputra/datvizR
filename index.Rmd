...
Seluruh grafik pada tipe grafik-deviasi menggunakan `gapminder` dataset dengan beberapa proses manipulasi data. Column + Line Timeline, Connected Scatter Plot, Bubble, serta XY Heatmap pada tipe grafik-korelasi juga menggunakan `gapminder` dataset.
...
diverging_bar <- diverging_bar_df %>%
  ...
  geom_textvline(xintercept = 0,
                 ...
                 color = '#660d20') +
  theme_dev +
  theme(axis.line.y = element_line(color = '#660d20',
                                   size = .5)) +
...
surplus_deficit_filled_line <- surplus_deficit_filled_line_df %>%
  ...
  theme_dev +
  theme(
    axis.title.y = element_text(color = '#660d20',
                              face = 'bold',
                              angle = 90),
