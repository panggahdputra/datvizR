...
```{r dot strip plot ranking}

dot_strip_plot_ranking <- main_df %>%
...
```{r dot strip plot ranking print, echo=FALSE, out.width = "100%"}
dot_strip_plot_ranking
```
...
```{r dot strip plot distr print, echo=FALSE, out.width = "100%"}
dot_strip_plot
```
