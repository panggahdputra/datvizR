...
Website ini saya susun dalam rangka belajar visualisasi data menggunakan bahasa pemrograman R sekaligus belajar R Markdown, serta belajar lain-lain, panjang untuk disebutkan.

Tentu saja, website ini masih dalam proses penyelesaian! 

***

## **Pendahuluan**

Sebelum melangkah lebih jauh, saya asumsikan pembaca sudah cukup paham bahasa pemrograman R dan sudah menginstal [R](https://cran.r-project.org/) dan [Rstudio](https://www.rstudio.com/products/rstudio/#Desktop).
...
Palet warna yang akan kita gunakan berasal dari [MetBrewer](https://github.com/BlakeRMills/MetBrewer){target="blank"}. 

***

##### Dataset

Insiprasi dari *main_df* yang akan kita gunakan berasal dari [flipbook_script.R](https://osf.io/vt2ny/){target="blank"} yang disebut oleh Cédric Scherer dalam websitenya, [Beyond Bar and Box Plots](https://z3tt.github.io/beyond-bar-and-box-plots/#import-data){target="blank"}.

*******

## **Prasarat**

Seperti yang sudah saya sebutkan sebelumnya, saya asumsikan pembaca sudah cukup paham bahasa pemrograman R dan sudah menginstal [R](https://cran.r-project.org/) dan [Rstudio](https://www.rstudio.com/products/rstudio/#Desktop).

***

### *Install Packages*

Pertama, kita harus instal terlebih dahulu (jika belum pernah diinstall sebelumnya pada perangkat anda ) *package-package* yang akan kita gunakan dalam membuat grafik.
...
library(patchwork)    # untuk membuat annotation on Population Pyramid
...
Kita akan menggunakan beberapa dataset. Sebagian besar grafik menggunakan dataset *main_df*. 
...
Untuk membuat dot strip plot (klasifikasi: peringkat), kita menggunakan dataset *df_for_rank_dotstrip*.
...
Untuk membuat cumulative curve, kita menggunakan *df_for_cum_curve*.
...
Kita menggunakan palet warna berbeda untuk tiap klasifikasi grafik. Untuk mempercantik klasifikasi grafik:peringkat, kita menggunakan palet *palette_ranking*. Untuk mempersempit fokus latihan, saya menyalin kode hex secara manual dari *Greek Palette* di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#greek){target="blank"}. Anda dapat mempelajari sendiri penggunaan palet warna di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#greek){target="blank"} tanpa harus menyalin code hex secara manual.
...
Untuk mempercantik klasifikasi grafik:distribusi, kita menggunakan palet *palette_distr*. Saya menyalin kode hex secara manual dari *Isfahan1 Palette* di [MetBrewer](https://github.com/BlakeRMills/MetBrewer#isfahan1){target="blank"}.
...
Kita menggunakan tema berbeda untuk tiap klasifikasi grafik.
Untuk mempercantik klasifikasi grafik:peringkat, kita menggunakan tema *theme_ranking*.
...
Untuk mempercantik klasifikasi grafik:distribusi, kita menggunakan tema *theme_distr*.
...
Klasifikasi grafik:peringkat digunakan untuk menunjukkan peringkat dari variabel-kategori berdasarkan nilai tertentu yang dimiliki masing-masing variabel-kategori.
...
Kita juga dapat mengurutkan dot strip plot sesuai dengan nilai tertentu. Dalam contoh dibawah, kita mengurutkan dot strip plot berdasarkan nilai maksimal dari masing-masing variabel-kategori.
...
Pada lollipop, kita akan cukup kesusahan melihat perbedaan jika selisih nilai tiap variabel-kategori sangat tipis. Untuk itu, kita lebih baik menampilkan nilai data di dalam lingkaran lollipop seperti dibawah ini.
...
Klasifikasi grafik:distribusi digunakan untuk menunjukkan distribusi data dari suatu dataset atau dari tiap variabel-kategori.
...
Pada dot strip plot diatas, kita cukup kesulitan mengetahui distribusi dari data yang memiliki nilai sama/ hampir sama. Untuk mempermudah interpretasi, kita dapat membuat stat dot plot  seperti di bawah ini.
...
Tidak seperti density plot, stat density plot menampilkan density dari tiap variabel-kategori. Stat density plot juga dapat menampilkan nilai kuantil dari tiap variabel-kategori.
